...
export class Migration20220627102135 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table `stats_historyentry` add index `stats_historyentry_stake_pool_entry_id_entry_nonce_index`(`stake_pool_entry_id`, `entry_nonce`);');
  }
